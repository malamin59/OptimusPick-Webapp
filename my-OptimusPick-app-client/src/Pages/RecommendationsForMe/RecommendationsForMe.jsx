            ...
            <thead className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white text-left">
              <tr>
                ...
                <th className="px-6 py-4 font-semibold">
                  <MdOutlineCalendarToday className="inline mr-1" /> Date
                </th>
                <th className="px-6 py-4 flex justify-center items-center font-semibold">
                  <MdAccessTime className="inline mr-1" /> Time
                </th>
