...
const MyQueriesBanner = () => {
  ...
  return (
     <div className="w-full mt-4 max-w-5xl mx-auto px-2 lg:pb-8 pb-6">
      <Slider {...settings}>
        {/* Slide 1 */}
        <div className="h-[200px] sm:h-[300px] md:h-[350px] overflow-hidden rounded-lg relative">
          ...
          <div className="relative z-10 flex flex-col justify-center items-center h-full text-white text-center px-4">
            <h2 className="text-xl sm:text-3xl font-bold">
              Fresh Ideas Grow Here
            </h2>
            <p className="mt-2 text-sm sm:text-lg">
              Discover inspiring queries every day
            </p>
          </div>
        </div>
        ...
        <div className="h-[200px] sm:h-[300px] md:h-[350px] overflow-hidden rounded-lg relative">
          ...
          <div className="relative z-10 flex flex-col justify-center items-center h-full text-white text-center px-4">
            ...
            <p className="mt-2 text-sm sm:text-lg">
              Browse the best user-submitted queries
            </p>
          </div>
        </div>
