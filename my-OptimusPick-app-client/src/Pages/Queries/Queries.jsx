    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 mb-20 lg:px-8">
      ...
      <div className="flex justify-center gap-4 mb-6">
        ...
        <button
          ...
          className={`px-4 py-2 rounded ${columns === 1 ? "bg-indigo-600 text-white" : "bg-gray-200"}`}
        >
          1 Column
        </button>
        <button
          onClick={() => setColumns(2)}
          className={`px-4 py-2 rounded ${columns === 2 ? "bg-indigo-600 text-white" : "bg-gray-200"}`}
        >
          2 Columns
        </button>
        <button
          onClick={() => setColumns(3)}
          className={`px-4 py-2 rounded ${columns === 3 ? "bg-indigo-600 text-white" : "bg-gray-200"}`}
        >
          3 Columns
        </button>
      ...
      {/* Grid of Cards */}
      <div className={`grid ${getGridColsClass(columns)} gap-6`}>
        {queries.map((querie) =>
        (
