...
import { FaBoxOpen, FaImage, FaRegCommentDots, FaRegEdit } from 'react-icons/fa';
...
const RecommendationSection = ({ queriesDetails, _id, handleCountRecommendation }) => {
    const { id } = useParams();
    // console.log(id)
    const { user } = UseAuth();
    ...
    const handleRecommendation = e => {
        ...
        axios.post(`${import.meta.env.VITE_API_URL}/allRecommendation`, recommendQueries)
            .then(res => {
        ...
        <div>
            <section className="max-w-3xl mx-auto mt-6 mb-10 p-8 bg-gradient-to-br from-white via-slate-50 to-blue-50 rounded-2xl shadow-lg border border-blue-100">
                ...
                <div className="flex items-center justify-center gap-3 mb-8 text-gray-700">
                    ...
                    <h2 className="text-3xl font-bold tracking-wide">Recommendation Section</h2>
                </div>
